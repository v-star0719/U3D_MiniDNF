...
{
	public int skillID;
	public List<DBSkillAttackRecord> attackList = new List<DBSkillAttackRecord>();
}
...
public class DBSkillTable
{
	...
	public static void Init()
	{
		...
		DBSkillAttackRecord[] recordArray = DBSkillAttackTable.instance.recordArray;
		DBSkillConf skill;
		for(int i=0; i<recordArray.Length; i++)
		{
			DBSkillAttackRecord conf = recordArray[i];
